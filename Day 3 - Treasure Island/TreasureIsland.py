...
crossroad_choice = input("You're at a cross road. Where do you want to go? Type 'left' or 'right'\n")
...
if crossroad_choice == "left":
    ...
    if lake_choice == "swim":
          ...
          if door_choice != "yellow":
            print("There's nothing but darkness here. Game Over. ")
          else:
            print("You found the treasure. You get 3 gold stars. *** ")  